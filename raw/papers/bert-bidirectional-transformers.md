...
BERT input representation diagram showing the sum of token, segment, and position embeddings.
...
<sup>8</sup> See (10) in [https://gluebenchmark.com/faq](https://gluebenchmark.com/faq).
...
<sup>10</sup>[https://gluebenchmark.com/leaderboard](https://gluebenchmark.com/leaderboard)
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="5">Top Leaderboard Systems (Dec 10th, 2018)</td>
    </tr>
    <tr>
        <td>Human</td>
        <td>-</td>
    ...
    <tr>
        <td colspan="5">Published</td>
    </tr>
    <tr>
        <td>BiDAF+ELMo (Single)</td>
        <td>-</td>
        <td>85.6</td>
        <td>-</td>
        <td>85.8</td>
    ...
    <tr>
        <td colspan="5">Ours</td>
    </tr>
    <tr>
        <td>BERT<sub>BASE</sub> (Single)</td>
        <td>80.8</td>
        <td>88.5</td>
        <td>-</td>
        <td>-</td>
    ...
    <tr>
        <td>BERT<sub>LARGE</sub> (Single)</td>
        <td>84.1</td>
        <td>90.9</td>
        <td>-</td>
        <td>-</td>
    ...
    <tr>
        <td>BERT<sub>LARGE</sub> (Ensemble)</td>
        <td>85.8</td>
        <td>91.8</td>
        <td>-</td>
        <td>-</td>
    ...
    <tr>
        <td>BERT<sub>LARGE</sub> (Sgl.+TriviaQA)</td>
    ...
    <tr>
        <td>BERT<sub>LARGE</sub> (Ens.+TriviaQA)</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
        <td>Human (expert)<sup>†</sup></td>
        <td>-</td>
        <td>85.0</td>
    </tr>
    <tr>
        <td>Human (5 annotations)<sup>†</sup></td>
        <td>-</td>
        <td>88.0</td>
    </tr>
  </tbody>
...
$\hat{s}_{i,j} = \max_{j \ge i} S \cdot T_i + E \cdot T_j$. We predict a non-null answer when $\hat{s}_{i,j} > s_{null} + \tau$, where the threshold $\tau$ is selected on the dev set to maximize F1. We did not use TriviaQA data for this model. We fine-tuned for 2 epochs with a learning rate of 5e-5 and a batch size of 48.
...
<table>
  ...
  <tbody>
    ...
    <tr>
        <td colspan="3">Fine-tuning approach</td>
    </tr>
    <tr>
        <td>BERT<sub>LARGE</sub></td>
        <td>96.6</td>
    ...
    <tr>
        <td colspan="3">Feature-based approach (BERT<sub>BASE</sub>)</td>
    </tr>
    <tr>
        <td>Embeddings</td>
        <td>91.0</td>
...
<table>
  <thead>
    <tr>
        <th colspan="3">Hyperparams</th>
        <th> </th>
        <th colspan="3">Dev Set Accuracy</th>
    </tr>
    <tr>
        <th>#L</th>
        <th>#H</th>
...
Diagram showing differences in pre-training model architectures for BERT (Ours), OpenAI GPT, and ELMo. BERT uses bidirectional Transformers, OpenAI GPT uses left-to-right Transformers, and ELMo uses concatenated left-to-right and right-to-left LSTMs.
...
Illustrations of Fine-tuning BERT on Different Tasks: (a) Sentence Pair Classification Tasks, (b) Single Sentence Classification Tasks, (c) Question Answering Tasks, (d) Single Sentence Tagging Tasks.
...
<sup>15</sup>[https://gluebenchmark.com/faq](https://gluebenchmark.com/faq)
...
<table>
  <thead>
    <tr>
        <th>Pre-training Steps (Thousands)</th>
        <th>BERT_BASE (Masked LM)</th>
        <th>BERT_BASE (Left-to-Right)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table>
  <thead>
    <tr>
        <th colspan="3">Masking Rates</th>
        <th colspan="3">Dev Set Results</th>
    </tr>
    <tr>
        <th>MASK</th>
        <th>SAME</th>
